...
var taskInput=document.querySelector("#new-todo");//Add a new task.
var addButton=document.querySelector(".btn-add");//first button
var incompleteTaskHolder=document.querySelector("#todo-incompleted-list");
var completedTasksHolder=document.querySelector("#todo-completed-list");
...
var createNewTaskElement=function(taskString){
    ...
    label.className="todo-section__field todo-item__label";
    ...
    editInput.type="text";
    editInput.className="todo-section__field todo-input";
